from algorithms.pvd_ver_lib import pvd_lib
...
def encryptPVD(ref_image_path, secret_file_path, output_image_path):
    pvd_obj = pvd_lib()
...
def decryptPVD(ref_image_path, output_secret_path, output_image_path):
    pvd_obj = pvd_lib()
